...
-- script input { rnea_no_vtree_input ($loaddata "data/N500000_bf1_rnea_bench.in") }
-- script input { rnea_no_vtree_input ($loaddata "data/N1000000_bf1_rnea_bench.in") }
...
-- script input { rnea_no_vtree_input ($loaddata "data/N500000_bf2_rnea_bench.in") }
-- script input { rnea_no_vtree_input ($loaddata "data/N1000000_bf2_rnea_bench.in") }
...
-- script input { rnea_no_vtree_input ($loaddata "data/N500000_bf100_rnea_bench.in") }
-- script input { rnea_no_vtree_input ($loaddata "data/N1000000_bf100_rnea_bench.in") }
