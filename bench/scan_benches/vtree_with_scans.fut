...
-- an operator as input
  ...
  def mk_preorder 'a [n] (ns: t0 a [n]) : t a [n] =
    ...
    let parens = scatter (replicate (2 * n) (-1)) lp (replicate n 1)
  ...
  def rootfix_we 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) ({lp, rp, data}: t a [n]) : [n]a =
    let I = replicate (2 * n) ne
    let L = scatter I lp data
    let R = scatter L rp (map inv data)
  ...
  def irootfix_we 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) (t: t a [n]) : [n]a =
    map2 op (rootfix_we op inv ne t) t.data

  def rootfix_blocked 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) ({lp, rp, data}: t a [n]) (bs : i64) : [n]a =
    let I = replicate (2 * n) ne
    let L = scatter I lp data
    let R = scatter L rp (map inv data)
  ...
  def irootfix_blocked 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) (t: t a [n]) (bs: i64) : [n]a =
    map2 op (rootfix_blocked op inv ne t bs) t.data
  ...
  def ileaffix_we 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) ({lp, rp, data}: t a [n]) : [n]a =
    let I = replicate (2 * n) ne
    let L = scatter I lp data
  ...
  def leaffix_we 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) (t: t a [n]) : [n]a =
    map2 op (ileaffix_we op inv ne t) (map inv t.data)

  def ileaffix_blocked 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) ({lp, rp, data}: t a [n]) (bs : i64) : [n]a =
    let I = replicate (2 * n) ne
    let L = scatter I lp data
  ...
  def leaffix_blocked 'a [n] (op: a -> a -> a) (inv: a -> a) (ne: a) (t: t a [n]) (bs:i64) : [n]a =
    map2 op (ileaffix_blocked op inv ne t bs) (map inv t.data)
