...
def crba_vtree [n] (joint_types : [n]jointT)
  ...
  let Ics_to_root = map3 (\bXa_F aXb_M I -> bXa_F `matmul_f64`  (I `matmul_f64` aXb_M)) to_root_F from_root_to_body_M Is
  let vtree_Ics_root = T.lprp <| mkt2 lp rp Ics_to_root 
