...
entry test_rnea_optimal_ds [n] (children : f64) (qs : [n]f64) (qds : [n]f64) (qdds : [n]f64)  : [n]f64 =
  let (_, p, js, Is, Xtrees) = autoTreeC n children 0f64 1f64
  let gravity = {w = [0,0,0f64], v_O = [0,0, -9.81f64]}
  in rnea_optimized_ds_seq p js Is Xtrees gravity qs qds qdds 
...
entry test_rnea [n] (children : f64) (qs : [n]f64) (qds : [n]f64) (qdds : [n]f64)  : [n]f64 =
  ...
  in rnea' p js Is Xtrees gravity qs qds qdds 
